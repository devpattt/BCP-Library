                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                             <?php
                                  ...
                                  $sql = "SELECT booking_id, student_name, student_number, section, contact_number, booking_start_date, booking_end_date, status FROM bookings";
                                  ...
                                  if ($result->num_rows > 0) {
                                      while($row = $result->fetch_assoc()) {
                                          ...
                                          echo "<td>" . htmlspecialchars($row["booking_start_date"]) . "</td>";
                                          echo "<td>" . htmlspecialchars($row["booking_end_date"]) . "</td>";
